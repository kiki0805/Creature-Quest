...
export const Play = ({style}) => {
  return (
    <Icon viewBox="0 0 256 256" style={style}>
...
export const Record = ({style}) => {
  return (
    <Icon viewBox="0 0 39.989 39.989" style={style}>
      <G fillRule="nonzero" stroke="none" strokeWidth={1} fill="none">
        <Path
          d="M19.994,0C8.952,0,0,8.952,0,19.995c0,11.043,8.952,19.994,19.994,19.994s19.995-8.952,19.995-19.994
...
export const Microphone = ({style}) => {
  return (
    <Icon viewBox="0 0 24 24" style={style}>
      <G fillRule="nonzero" stroke="none" strokeWidth={1} fill="none">
        <Path
...
export const Example = ({style}) => {
  return (
    <Icon viewBox="0 0 870 873" style={style}>
      <G fillRule="nonzero" stroke="none" strokeWidth={1} fill="none">
        <Path
