      ...
      <SafeAreaView style={{height: '100%', width: '100%'}}>
        <VStack
          ...
          <Link to="/" underlayColor="transparent" style={{width: '100%'}}>
            <Center height="5" bg="secondary.500" shadow={3}>
              I'm Main. Go back
            </Center>
          </Link>
        </VStack>
        <VStack
          ...
          <Box style={{backgroundColor: 'white', height: 60, width: '80%'}}>
            <Flex direction="row">
              <Center h={60} width="50%" bg="primary.100">
                <IconButton
                  icon={<Icon as={Example} />}
                  borderRadius="full"
                  onPress={() => {
              ...
              <Center h={60} width="50%" bg="primary.200">
                <IconButton
                  icon={<Icon as={Example} />}
                  borderRadius="full"
                  onPress={() => {
        ...
        <Box style={{height: '50%', backgroundColor: 'blue'}}></Box>
        <Flex style={{height: '50%', backgroundColor: 'red'}}>sas</Flex>
      </SafeAreaView>
    );
  }
}
